...
* write tests to ensure the `/api/v1/notes` endpoint responds as described for each condition below:
 * `GET`: test 404, it should respond with 'not found' for valid requests made with an id that was not found
	 * For today's lab let id of 0 equal a 'not found' id
